...
//schools
  ...
  education.schools.forEach(function(school) {
    ...
    var formattedSchooldMajor = HTMLschoolMajor.replace("%data%", school.major);
...
//online coursies
  ...
  education["online coursies"].forEach(function(course) {

    if(education["online coursies"].length > 0) {
